...
def main():
    ...
    target_cloud = pcl.load('E:/data_odometry/dataset/sequences/09/velodyne_pcd/000054.pcd')
    ...
    input_cloud = pcl.load('E:/data_odometry/dataset/sequences/09/velodyne_pcd/000053.pcd')
